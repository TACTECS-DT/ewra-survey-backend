...
class ActivityItemGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = ActivityItem.objects.select_related('main_activity',"activity_type","affiliate","center","branch").all()
        ...
        serializer = all_serializers.ActivityItem_FORM_GET_Serializer(paginated_records, many=True)
