...
class MainActivityGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = MainActivity.objects.all()
        ...
        serializer = all_serializers.MainActivity_FORM_GET_Serializer(paginated_records, many=True)
