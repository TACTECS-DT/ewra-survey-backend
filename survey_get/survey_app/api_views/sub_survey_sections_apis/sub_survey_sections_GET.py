...
class SubSurveySectionGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = SubSurveySection.objects.select_related("main_survey_sections").all()
        ...
        serializer = all_serializers.SubSurveySection_FORM_GET_Serializer(paginated_records, many=True)
