...
class CenterGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = Center.objects.select_related("governorate").all()
        ...
        serializer = all_serializers.Center_FORM_GET_Serializer(paginated_records, many=True)
