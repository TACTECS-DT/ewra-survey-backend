...
class GovernoratePATCHGETAPIView(APIView):
    ...
    def patch(self, request, pk=None):
        ...
        serializer = all_serializers.Governorate_PATCH_POST_Serializer(instance, data=request.data, partial=True)
        ...
        response_serializer = all_serializers.Governorate_FORM_GET_Serializer(instance)
    ...
    def get(self, request, pk=None):
        ...
        response_serializer = all_serializers.Governorate_FORM_GET_Serializer(record)
        return Response(response_serializer.data, status=status.HTTP_200_OK)
