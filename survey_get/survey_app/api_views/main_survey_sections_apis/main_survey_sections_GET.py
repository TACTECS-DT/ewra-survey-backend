...
class MainSurveySectionGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = MainSurveySection.objects.select_related("main_activity","activity_type").all()
        ...
        serializer = all_serializers.MainSurveySection_FORM_GET_Serializer(paginated_records, many=True)
