...
class QuestionBankGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = QuestionBank.objects.prefetch_related("sub_survey_sections","kpi_tags").all()
        ...
        serializer = all_serializers.QuestionBank_FORM_GET_Serializer(paginated_records, many=True)
