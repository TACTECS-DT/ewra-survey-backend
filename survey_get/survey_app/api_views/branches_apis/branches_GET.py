...
class BranchGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = Branch.objects.select_related("affiliate").all()
        ...
        serializer = all_serializers.Branch_FORM_GET_Serializer(paginated_records, many=True)
