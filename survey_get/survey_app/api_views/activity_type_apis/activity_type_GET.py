...
class ActivityTypeGETAPIView(APIView):
    ...
    def get(self, request):
        ...
        records = ActivityType.objects.select_related("main_activity").all()
        ...
        serializer = all_serializers.ActivityType_FORM_GET_Serializer(paginated_records, many=True)
